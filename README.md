...
<body>
    <!-- Navbar -->
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top shadow-sm">...</nav>
...
.navbar { background-color: #1877f2 !important; }
.card { border-radius: 10px; box-shadow: 0 1px 2px rgba(0, 0, 0, 0.1); }
